...
char criptoCaractere(char caractere, int senha) {
    ...
    if(caractere == 32 || caractere == 0 || caractere == 10) return caractere;
    if(caractere == -1) return ' ';
    ...
    while(opcao != 'S' && opcao != 's') {
        ...
        switch(opcao) {
            ...
            case 'C':
                ...
                printf("Digite a senha(a mesma senha devera ser usada para descriptografar): \n");
                scanf("%d", &senha);
